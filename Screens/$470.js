...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(498.225,47.425);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Ah/CjIAMg4QAtAMAjAAQAsgBAWgVQAXgUgBgpIAAiaIinAAIAAg6IDyAAIAADGQAABOgpAnQgpAmhJAAQgsAAg4gOg");
	this.shape_1.setTransform(462.15,47.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgwCvQgOgBgSgEIABg5QAUADAXAAQAWAAALgMQAKgMAAgaIAAi4IhAAAIAAg6ICKAAIAAD4QAAAygaAcQgaAbgvAAQgQAAgOgCg");
	this.shape_2.setTransform(434.125,47.725);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(404.325,47.375);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AioCtIAAg6IAUABQAXAAALgMQAMgMAAgaIAAhfQAAgXAFgYQAHgZAKgQIg7AAIAAg6ICqAAQBEAAAjAhQAiAhABBCIAADXIhKAAIgBjcQAAgkgPgQQgPgRghAAIguAAQgHAQgEAWQgEAWAAAVIAABrQAAAzgZAbQgaAbgvAAQgSAAgWgDg");
	this.shape_4.setTransform(364.65,47.625);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("ABCCuIAAjdQAAgjgRgQQgRgRgjAAIiHAAIAAg6ICLAAQBDAAAkAhQAkAhAAA/IAADagAiLCuIAAh3QAAgdAFgQQAFgPAIgNIA8AAQgGAYAAAqIAAB+g");
	this.shape_5.setTransform(314.375,47.425);
	...
	this.shape_6.setTransform(277.075,47.425);
	...
	this.shape_7.setTransform(237.475,53.525);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AALCuIAAkhIibAAIAAg6IEhAAIAAA6Ig7AAIAAEhg");
	this.shape_8.setTransform(201.85,47.425);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ABCCuIAAjcQAAgjgPgRQgQgRghAAIhDAAIAAEhIhKAAIAAlbICNAAQCJAAABCEIAADXg");
	this.shape_9.setTransform(167.425,47.425);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("Ag+DhIB3khIjCAAIAAigIBLAAIAABlIDIAAIAAAwIh5Esg");
	this.shape_10.setTransform(117.625,42.35);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgwCvQgOgBgSgEIABg5QAUADAXAAQAWAAALgMQAKgMAAgaIAAi4IhAAAIAAg6ICKAAIAAD4QAAAygaAcQgaAbgvAAQgQAAgOgCg");
	this.shape_11.setTransform(88.575,47.725);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAuCuIAAjrQABgZgQgOQgOgPgZAAIhvAAIAAg6IByAAQAmAAAdAOQAcAOAQAaQAOAaAAAlIAADmg");
	this.shape_12.setTransform(62.5,47.425);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AioCtIAAg6IAUABQAXAAALgMQAMgMAAgaIAAhfQAAgXAFgYQAHgZAKgQIg7AAIAAg6ICqAAQBEAAAjAhQAiAhABBCIAADXIhKAAIgBjcQAAgkgPgQQgPgRghAAIguAAQgHAQgEAWQgEAWAAAVIAABrQAAAzgZAbQgaAbgvAAQgSAAgWgDg");
	this.shape_13.setTransform(28.05,47.625);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgHBiIAAiJIg7AAIAAg6ICFAAIAADDg");
	this.shape_14.setTransform(-0.325,39.825);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AiIDrIAAj3QAAgcAGgQQAFgQAHgOIA9AAQgHAYAAAsIAAD9gAgSA4QAngBAXgYQAXgYAAgpIAAiOIjPAAIAAg6IEZAAIAADGQAAAtgTAiQgUAhgkASQgkASgwABg");
	this.shape_15.setTransform(-27.725,53.525);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol5copy, new cjs.Rectangle(-49.1,0,567.5,92.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(308.55,121.15,1,1,0,0,0,410,419.5);
	...
	// video
	this.instance_3 = new lib.an_Video({'id': 'instance_3', 'src':'videos/תפעול-%20הכנסת%20נשק%20לנרתיק-.mp4', 'autoplay':true, 'controls':true, 'muted':false, 'loop':false, 'poster':'', 'preload':true, 'class':'video'});
...
p.nominalBounds = new cjs.Rectangle(-593.4,-362,2052,902.7);


// stage content:
(lib._470 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(720,446.5,1372.1,453.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/_10copy.png?1636533418690", id:"_10copy"},
		{src:"images/BG.png?1636533418690", id:"BG"},
		{src:"components/lib/jquery-3.4.1.min.js?1636533418690", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1636533418690", id:"sdk/anwidget.js"},
		{src:"components/video/src/video.js?1636533418690", id:"an.Video"}
	],
	preloads: []
};
