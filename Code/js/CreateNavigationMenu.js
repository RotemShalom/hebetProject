...
// Fathers
    var father1 = Create_Link(1, true, 'null', 'bar0_1',' מבוא');
    var father2 = Create_Link(1, true, 'null', 'bar2_4','הכרה תיאור תכונות');
    var father3 = Create_Link(1, true, 'null', 'bar5_7','הוראות בטיחות');
    var father4 = Create_Link(1, true, 'null', 'bar8_14','תפעול');
    var father5 = Create_Link(1, false, 'a15', 'bar15_15','סיכום ');
    ...
    var ul_Son3 = document.createElement('ul');
    ul_Son3.className = "dropdown-menu";
    
    var ul_Son4 = document.createElement('ul');
    ul_Son4.className = "dropdown-menu";
    
      
    // Adding to the dropdown menu list 
    ul_Son1.appendChild(Create_Link(2, false, 'a0', 'bar0_0','גלוק'));
    ul_Son1.appendChild(Create_Link(2, false, 'a1', 'bar1_1',' הצורך באקדח לחימתי'));
    
    ul_Son2.appendChild(Create_Link(2, false, 'a2', 'bar2_2','חלקי האקדח'));
    ul_Son2.appendChild(Create_Link(2, false, 'a3', 'bar3_3','תהליך פעולת הירי'));
    ul_Son2.appendChild(Create_Link(2, false, 'a4', 'bar4_4','מנגנוני אבטחת האקדח'));
    
    ul_Son3.appendChild(Create_Link(2, false, 'a5', 'bar5_5','כללי'));
    ul_Son3.appendChild(Create_Link(2, false, 'a6', 'bar6_6','נשיאת אקדח'));
    ul_Son3.appendChild(Create_Link(2, false, 'a7', 'bar7_7','שימוש באקדח'));
    
    ul_Son4.appendChild(Create_Link(2, false, 'a8', 'bar8_8','סד"פ פריקה'));
    ul_Son4.appendChild(Create_Link(2, false, 'a9', 'bar9_9','סד"פ פירוק'));
    ul_Son4.appendChild(Create_Link(2, false, 'a10', 'bar10_10','סד"פ הרכבה'));
    ul_Son4.appendChild(Create_Link(2, false, 'a11', 'bar11_11','סד"פ תיתוב ובדיקת סטריליות'));
    ul_Son4.appendChild(Create_Link(2, false, 'a12', 'bar12_12','בדיקת תקינות'));
    ul_Son4.appendChild(Create_Link(2, false, 'a13', 'bar13_13','ניקוי '));
    ul_Son4.appendChild(Create_Link(2, false, 'a14', 'bar14_14','הכנסת האקדח לנרתיק'));
    
    
   father1.appendChild(ul_Son1);
   father2.appendChild(ul_Son2);
   father3.appendChild(ul_Son3);
   father4.appendChild(ul_Son4);
    ...
    Menu_ul.appendChild(father4);
    Menu_ul.appendChild(father5);
